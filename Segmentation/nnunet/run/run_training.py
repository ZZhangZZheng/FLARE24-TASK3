...
def main():
    ...
    # # model = trainer.network.train()
    # # summary(model,(48, 224, 224))
    # print("ssssssssssssssssssssssssssssssssssssssss")
    #
    # with torch.cuda.device(0):
    #     model = trainer.network.train()
    #     macs, params = get_model_complexity_info(model, (48, 224, 224), as_strings=True, backend='pytorch',print_per_layer_stat = True, verbose = True)
